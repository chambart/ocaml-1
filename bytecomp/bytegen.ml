...
let comp_primitive p args =
  ...
  | Pnegfloat 1 -> Kccall("caml_neg_float", 1)
  | Pabsfloat 1 -> Kccall("caml_abs_float", 1)
  | Paddfloat 1 -> Kccall("caml_add_float", 2)
  | Psubfloat 1 -> Kccall("caml_sub_float", 2)
  | Pmulfloat 1 -> Kccall("caml_mul_float", 2)
  | Pdivfloat 1 -> Kccall("caml_div_float", 2)

  | Pnegfloat n -> failwith(Printf.sprintf "Pnegfloat %i" n)
  | Pabsfloat n -> failwith(Printf.sprintf "Pabsfloat %i" n)
  | Paddfloat n -> failwith(Printf.sprintf "Paddfloat %i" n)
  | Psubfloat n -> failwith(Printf.sprintf "Psubfloat %i" n)
  | Pmulfloat n -> failwith(Printf.sprintf "Pmulfloat %i" n)
  | Pdivfloat n -> failwith(Printf.sprintf "Pdivfloat %i" n)
