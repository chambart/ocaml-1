...
CAMLC=boot/ocamlrun boot/ocamlc -nostdlib -g -I boot
CAMLOPT=boot/ocamlrun ./ocamlopt -nostdlib -g -I stdlib -I otherlibs/dynlink
...
ASMCOMP=asmcomp/arch.cmo \
  ...
  asmcomp/flambdaanf.cmo \
  asmcomp/flambdaexport.cmo \
  asmcomp/flambdareachability.cmo \
  asmcomp/clambda.cmo asmcomp/printclambda.cmo asmcomp/compilenv.cmo \
  asmcomp/flambdapurity.cmo \
